...
internal static class IntTemplate
{
    public static string Generate(StrongIdModel model)
    {
        ...
        return $$"""
                      ...
                      : IEquatable<{{model.Name}}>, IComparable<{{model.Name}}>, IParsable<{{model.Name}}>
                  {
                      ...
                      public {{model.Name}}(int value) => Value = value;
                  
                      public static {{model.Name}} From(int value) => new(value);
                      ...
                      public static explicit operator {{model.Name}}(int value) => new(value);
                      public static implicit operator int({{model.Name}} id) => id.Value;
