...
internal static class LongTemplate
{
    public static string Generate(StrongIdModel model)
    {
        ...
        return $$"""
                      ...
                      : IEquatable<{{model.Name}}>, IComparable<{{model.Name}}>, IParsable<{{model.Name}}>
                  {
                      ...
                      public {{model.Name}}(long value) => Value = value;
                  
                      public static {{model.Name}} From(long value) => new(value);
                      public static {{model.Name}} Empty => new(0);
                      ...
                      public static explicit operator {{model.Name}}(long value) => new(value);
                      public static implicit operator long({{model.Name}} id) => id.Value;
